...
import { formatMs, toHumanScenario } from '../../utils/format'
...
export const LatencyChart: React.FC<Props> = ({ results, metric, title }) => {
  ...
  return (
    <div style={{ background: '#1e293b', borderRadius: '12px', padding: '24px', border: '1px solid #334155' }}>
      <h3 style={{ color: '#f8fafc', margin: '0 0 20px', fontWeight: 600, fontSize: '15px' }}>{title}</h3>
